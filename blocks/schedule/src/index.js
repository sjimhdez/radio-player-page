/**
 * Radio Schedule block (radplapag/schedule).
 *
		...
		<>
			<InspectorControls>
				<PanelBody title={ __( 'Radio Schedule Settings', 'radio-player-page' ) } initialOpen={ true }>
					...
					/>
					<SelectControl
						label={ __( 'Sort Days', 'radio-player-page' ) }
						value={ dayOrderValue }
						options={ [
							{ label: __( 'Start with Current Day', 'radio-player-page' ), value: 'current_first' },
